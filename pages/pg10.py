...
# page 1 data
df = pd.read_csv("datasets/aprenden_rapido_6to.csv")
...
layout = html.Div([
        ...
        dbc.Col([
            dcc.Dropdown(options=[{'label': x, 'value': x} for x in list_comparacion_por_ordenada], multi=False, persistence=True, persistence_type='memory', value='Género, matemática', id='page10-comparacion_por_elect')
        ], width=6),
    ]),
        dbc.Row([
        dbc.Col([
