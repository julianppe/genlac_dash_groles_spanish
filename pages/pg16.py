...
# page 1 data
df = pd.read_csv("datasets/mujer_casa_hombre_trabajo.csv")
...
layout = html.Div([
        ...
        dbc.Col([
            dcc.Dropdown(options=[{'label': x, 'value': x} for x in list_comparacion_por_ordenada], multi=False, persistence=True, persistence_type='memory', value='Total', id='page16-comparacion_por_elect')
        ], width=6),
    ]),
        dbc.Row([
        dbc.Col([
